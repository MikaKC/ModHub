...
void ProjectsLayer::customSetup()
{
	...
	pCells.push_back(ProjectCell::create("Suck"));
	pCells.push_back(ProjectCell::create("Big"));
	pCells.push_back(ProjectCell::create("Juicy"));
	pCells.push_back(ProjectCell::create("Cock"));
